    ...
    <Sidebar collapsible="icon" className="border-none">
      <SidebarHeader className="min-h-15 flex justify-center">
        ...
        >
          ...
          >
            <strong className="border h-full p-2 bg-[#28AF60] rounded-md">
      ...
      {/* <SidebarFooter className="p-4 border-t border-white/10 text-xs text-muted-foreground italic bg-[#2c2c2c]"></SidebarFooter> */}
    </Sidebar>
  );
};
